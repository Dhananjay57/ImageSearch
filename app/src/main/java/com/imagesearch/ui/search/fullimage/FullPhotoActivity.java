...
//
//public class FullPhotoActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener{
//
//    @BindView(R.id.photo_full_list)
...
//
//    private ArrayList<Hits> mGalleryItems;
...
//    };
//
//    public static void startActivity(Context context, ArrayList<Hits> imageList, int position, ImageListAdapter.ViewHolder holder) {
//        Intent intent = new Intent(context, FullPhotoActivity.class);
//        intent.putExtra(PHOTO_GALLERY_LIST, imageList);
//        intent.putExtra(PHOTO_FOCUSED_INDEX, position);
//
////        ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(
////                context, holder.itemView, ViewCompat.getTransitionName(holder.mPhotoImg));
//
...
//            Hits item = mGalleryItems.get(position);
//
//            final PhotoView photoView = new PhotoView(FullPhotoActivity.this);
//
//            // The tag is needed for later getSelectedItem from the ViewPager
//            photoView.setTag(LAYOUT_TAG_PREFIX + position);
//
//            ViewCompat.setTransitionName(photoView, String.valueOf(position));
//
//            // Define thumbnail request, using the thumbnail img (which is already been cached if loaded in previous list activity)
//            RequestBuilder<Drawable> thumbnailBuilder =  Glide.with(FullPhotoActivity.this)
...
//
//                        Toast.makeText(FullPhotoActivity.this, "Load image fail", Toast.LENGTH_SHORT).show();
//
//                        return false;
//                    }
//
...
//                    .load(Uri.parse(item.getLargeImageURL()))
